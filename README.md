...
This tool searches [PubMed](https://pubmed.ncbi.nlm.nih.gov/) for you and saves every match to a CSV, with title, abstract, authors, journal, year, DOI, and link all filled in. It also adds three blank columns for you to fill in while screening:
